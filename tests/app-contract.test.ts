...
test('merchant feedback center provides product applications and feedback flows', () => {
  ...
  assert.match(appSource, /class="product-application-list"/)
  assert.match(appSource, /v-for="option in filteredProductApplicationOptions"/)
  assert.match(appSource, /product-application-list-item/)
  ...
  assert.match(cssSource, /\.product-application-list\s*\{/)
  assert.match(cssSource, /\.product-application-list-item\s*\{/)
